...
/*	@CachePut(value="customers", key="#id")
	...
	public JSONObject getMjson(String roles, boolean superuser, LutUser loguser) throws JSONException{
		...
		if(superuser){
    		...
    		wmap.put("gname", "");
    		wmap.put("username", loguser.getUsername());
    		ulist.put(wmap);  
	...
	public JSONObject getUjson(String roles, boolean superuser,LutUser loguser) throws JSONException{
